...
cmd({
  pattern: "goku-crash",
  use: ".goku-crash <@user> or <number>",
  category: "other",
  desc: "goku-crash Function by inconnu boy",
  filename: __filename
}, async (conn, m, mek, { args, reply }) => {
  if (!args[0]) return await reply("*Reply to a user or provide a number!* (ex: .goku-crash 554xxxxxxx)");
